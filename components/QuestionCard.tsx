...
import { categoryIcons, difficultyConfig } from '../constants.ts';
import { IconBrain, IconCheckCircle, IconLightbulb, IconSparkles, IconTrophy, IconXCircle, IconZap } from './IconComponents.tsx';
